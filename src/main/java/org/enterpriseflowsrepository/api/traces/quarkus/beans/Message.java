...
public class Message {
  ...
  public enum Level {
    ...
    private static final Map<String, Message.Level> CONSTANTS = new HashMap<String, Message.Level>();
  ...
  public enum Type {
    ...
    private static final Map<String, Message.Type> CONSTANTS = new HashMap<String, Message.Type>();
    private final String value;
