...
/**
 * Main class of this Quarkus application.
 * 
 * <p>JAX-RS implementation. It allow us to initialize our context plus generate OpenAPI metadata with Apache the Microprofile libraries.
 */
@ApplicationPath("/")
@OpenAPIDefinition(
    info = @Info(
