...
/**
 * RESTful implementation of the {@link Trace} object.
 * 
 * <p>JAX-RS interface.
 */
@Path("/trace")
...
public interface TraceResource {
  ...
  /**
   * Gets a list of {@link Trace} entities from a selection.
   * 
   * @param after   All returned objects will have been created after or at that date
   * @param before  All returned objects will have been created before or at that date
   * @param keys    All returned objects will have all the corresponding keys
   * @return        Fetched {@link Trace} entities
   */
  @GET
  ...
  /**
   * Bulk usage for put multiple {@link Trace} object with one call.
   * 
   * @param data  Entities to insert
   * @return      Request validation. 200 if OK, 400 if the request of malformuled.
   */
  @PUT
  ...
  /**
   * Creates a new instance of a {@link Trace}.
   * 
