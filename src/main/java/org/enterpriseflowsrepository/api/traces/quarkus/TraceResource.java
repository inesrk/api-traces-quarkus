...
public interface TraceResource {
  ...
  List<Trace> getTraces(
    ...
    @QueryParam("keys") @Parameter(description = "All returned objects will have all the corresponding keys. Please list them with comas.", required = true) List<String> keys);
